export const portfolioData = {
  ...
  social_links: [
    {
      name: "GitHub",
      url: "https://github.com/iammanoj807",
      icon: "fa-brands fa-github",
      color: "#FFFFFF",
    },
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/manoj-kumar-thapa-7595a5168",
      icon: "fa-brands fa-linkedin-in",
      color: "#0077B5",
    },
    {
      name: "LeetCode",
      url: "https://leetcode.com/u/manojthapa/",
      icon: "simple-icons:leetcode",
      color: "#FFA116",
    },
    {
      name: "Blog",
      url: "https://hamropedia.com",
      icon: "fa-solid fa-blog",
      color: "#FFA500",
    },
    {
      name: "Email",
      url: "mailto:thapam807@gmail.com",
  ...
  experience: [
    {
      ...
      company_logo:
        "https://www.aston.ac.uk/themes/custom/aston_university/logo.svg",
  ...
  projects: [
    {
      title: "Planck AI",
      description:
        "Created agentic AI system with multi-step reasoning combining GPT-4o with real-time web search and document analysis capabilities.",
    ...
    },
    {
      ...
      description:
        "Developed full-stack e-commerce application with JWT authentication, shopping cart, order tracking, and responsive React frontend with dark mode.",
    ...
    },
    {
      title: "CogniGraph",
      description:
        "Built AI-powered knowledge graph explorer that transforms PDFs into interactive visualizations with entity extraction and RAG-based document chat.",
